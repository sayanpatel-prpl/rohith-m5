...
export type ConfidenceLevel = "verified" | "derived" | "estimated";
...
/**
 * Literal union of all 11 section route paths.
 * V2 adds 'am-value-add' and 'what-this-means' compared to v1.
 */
